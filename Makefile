...
PYTHON_LIBS_EXCLUDE_LIST := m pthread
PYTHON_SETUP_PY_ARGS :=
ifndef PYTHON_WITH_DEPS
PYTHON_LIBS_EXCLUDE_LIST += nvidia-ml cublas cudart curand cusparse cuda cudnn opencv_core opencv_imgproc opencv_imgcodecs mklml_intel mkldnn iomp5 nccl
else
